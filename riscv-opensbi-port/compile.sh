...
#python3 ../tools/vmem_to_ddr3_init.py -i ./build/platform/template/firmware/fw_dynamic.vmem -i2 /home/shc/projects/clones/riscv-linux-ue/vmlinux.vmem -i3 ./platform/template/custom.dtb.vmem -o ./build/platform/template/firmware/fw_dynamic_mem_init.txt;
