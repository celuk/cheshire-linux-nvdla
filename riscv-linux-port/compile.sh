...
make ARCH=riscv CROSS_COMPILE=$(pwd)/../riscv-toolchain-custom/_install/bin/riscv64-unknown-linux-gnu- -j$(nproc);
...
python3 ../tools/bin2hex.py ./arch/riscv/boot/Image > ./arch/riscv/boot/Image.hex;
#$(pwd)/../riscv-toolchain-custom/_install/bin/riscv64-unknown-linux-gnu-objcopy -O binary ./vmlinux vmlinux.bin
#python3 ../tools/bin2hex.py ./vmlinux.bin > ./vmlinux.hex;
